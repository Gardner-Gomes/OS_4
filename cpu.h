void add_n(int * count, unsigned int rand_pids[], PCB_p * privelaged, int * priv_length, fifo_queue new_procs);
int checkTerm();
...
char * to_string_3(int iteration_count, priority_queue pq, PCB_p * privelaged);
